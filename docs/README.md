...
* [**1. Introducción y Contexto**](introduccion.md)\
  &#xNAN;_&#x43;ontexto estratégico de la Cruz Roja Seccional Valle, su modelo de sostenibilidad financiado por el Hemocentro y los retos para el periodo PETI 2026-2030._
* [**2. Arquitectura de Software**](arquitectura.md)\
  &#xNAN;_&#x45;l stack tecnológico moderno (Astro, React, Tailwind CSS y Zustand) que soporta el funcionamiento inmediato y autónomo del cuadro de mando sin dependencias de red masivas._
* [**3. Autodiagnóstico de Gobernanza (ISO/IEC 38500)**](diagnostico-madurez.md)\
  &#xNAN;_&#x44;etalle metodológico de las 10 dimensiones clave de gobierno que el CIO evalúa para balancear el riesgo de cumplimiento y la inversión._
* [**4. Cuadro de Mando Integral (Balanced Scorecard)**](cuadro-mando.md)\
  &#xNAN;_&#x41;nálisis exhaustivo de las métricas clave de rendimiento organizadas en las perspectivas de Finanzas, Clientes/Hemocentro, Procesos Internos y Aprendizaje._
* [**5. Análisis de n8n y Justificación de Exclusión**](/broken/pages/sac39OtJkOuos60eJ7B3)\
  &#xNAN;_&#x45;studio riguroso sobre las ventajas y desventajas de n8n, y las razones por las cuales se decidió usar una simulación en cliente (Zustand) y un API Gateway directo en producción._
* [**6. Motor Prescriptivo e Iniciativas FODA**](proyectos-prescriptivos.md)\
  &#xNAN;_&#x46;uncionamiento del motor de recomendaciones dinámicas causa-raíz y la lista de proyectos P1 (corto plazo) y P2 (largo plazo)._
