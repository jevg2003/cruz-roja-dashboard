...
Url: [https://cruz-roja-dashboard.vercel.app/](https://cruz-roja-dashboard.vercel.app/)

Github: [https://github.com/jevg2003/cruz-roja-dashboard](https://github.com/jevg2003/cruz-roja-dashboard)
...
3. **Uptime del Hemocentro**: $$\text{Uptime} = \min(99.8\%, 98.0\% + (\text{Servidores} \times 0.4\%) + (\text{Backups} \times 0.7\%) + (\text{B2 Azure} \rightarrow 99.8\%))$$
